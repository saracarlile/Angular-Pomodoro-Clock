$(document).ready(function () {
    ...
    var startStopSession = function () {
        ...
        function disableButton() {
            $('#minus-break, #plus-break, #minus-session, #plus-session, #reset-btn').attr('disabled', 'disabled').css('background-color', '#B2DFDB');
        ...
        function enableButton() {
            ...
            $('#reset-btn').removeAttr('disabled').css('background-color', '#FFCDD2');
